...
// манипулировать из разных мест
    ...
    private JMenuItem searchProgramMenuItem;
...
// Добавить его в главное меню
        ...
        JMenu referMenu = new JMenu("Справка");
// Добавить его в главное меню
...
// По умолчанию пункт меню является недоступным (данных ещѐ нет)
        ...
        // Создать новое "действие" по сохранению в текстовый файл
        Action programAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {

                JOptionPane.showMessageDialog(MainFrame.this,"Пекарская Виктория 2 курс 10 руппа");
            }
        };
// Добавить соответствующий пункт подменю в меню "Файл"
         searchProgramMenuItem = referMenu.add(programAction);
// По умолчанию пункт меню является недоступным(данных ещѐ нет)
        searchProgramMenuItem.setEnabled(true);
...
// Записать в поток вывода заголовочные сведения
            ...
            for (int i = 0; i < coefficients.length; i++) {
                out.print(coefficients[i] + "*X^" + i /*(coefficients.length - i - 1)*/);
